  ...
  return (
    <div className="home-shell">
      ...
      <nav className="home-nav">
        ...
        <button className="btn btn-primary home-nav-cta" onClick={() => navigate("/login")}>
          Get started →
        </button>
      </nav>
      ...
      <section className="home-hero">
        ...
        <div className="home-hero-actions fade-up d4">
          <button className="btn btn-primary home-btn-lg" onClick={() => navigate("/register")}>Get started free →</button>
          <a href="#how" className="btn btn-ghost home-btn-lg">See how it works</a>
        </div>
        <div className="home-stats fade-up d5">
          {[["3s", "Avg search time"], [vehicleCount, "Registered vehicles"], ["Free", "Service"]].map(([num, label]) => (
      ...
      <section className="home-section home-section-alt" id="cases">
        <div className="home-section-inner">
          <div className="home-section-header">
            ...
            <h2 className="home-section-title">Real situations, real solutions</h2>
            <p className="home-section-sub">Every day, people face situations where they need to reach a vehicle owner — fast. VahanConnect makes that possible.</p>
          </div>
          <div className="home-cases-grid">
            {USE_CASES.map(({ title, desc, icon }) => (
              <div key={title} className="home-case-card">
                <div className="home-case-icon"><CaseIcon name={icon} /></div>
      ...
      <section className="home-section" id="how">
        <div className="home-how-inner">
          <div className="home-section-header">
            ...
            <p className="home-section-sub">No complicated process. Register once, search anytime, message instantly.</p>
          </div>
      ...
      <section className="home-section" id="developer">
        <div className="home-dev-outer">
          ...
          <h2 className="home-section-title" style={{ marginTop: 16 }}>Made by a developer,<br />for real people.</h2>
          <p className="home-section-sub" style={{ margin: "0 auto" }}>
            VahanConnect isn't a corporate product. It's a project built with care to solve everyday problems that people face with vehicles.
          </p>
          <div className="home-dev-card">
            ...
            <p className="home-dev-bio">
              Passionate about building tools that solve real problems. VahanConnect started as an idea to make vehicle-owner communication easier and evolved into a full-stack production application — with security, clean architecture, and a thoughtful user experience.
            </p>
            <div className="home-dev-links">
              <a href="https://github.com/HMAjay" target="_blank" rel="noopener noreferrer" className="home-dev-link">
      ...
      <section className="home-cta-section">
        <div className="home-cta-inner">
          <span className="view-tag" style={{ display: "inline-block", marginBottom: 20 }}>Ready?</span>
          <h2 className="home-cta-title">Start finding vehicle owners today.</h2>
          <p className="home-cta-sub">Free to use. Just register and search.</p>
          <div className="home-cta-actions">
            <button className="btn btn-primary home-btn-lg" onClick={() => navigate("/register")}>Create free account →</button>
            <button className="btn btn-ghost home-btn-lg" onClick={() => navigate("/login")}>Sign in</button>
          </div>
        </div>
      </section>
      ...
      <footer className="home-footer">
        ...
        <span className="home-footer-copy">© 2026 VahanConnect. Built by Ajay.</span>
        <div className="home-footer-links">
          <a href="/register">Register</a>
          <a href="/login">Sign in</a>
          <a href="https://github.com/HMAjay" target="_blank" rel="noopener noreferrer">GitHub</a>
        </div>
      </footer>
