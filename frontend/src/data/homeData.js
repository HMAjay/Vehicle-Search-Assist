...
export const STEPS = [
  ["01", "Register your vehicle",   "Create a free account with your email, vehicle name, and plate number. Your details are secured and only shared when someone searches for your vehicle."],
  ["02", "Search any plate number", "Type the vehicle registration number from the dashboard. VahanConnect instantly finds the registered owner's profile in the database."],
  ["03", "Send a message",          "Contact the owner directly through the built-in messaging system. No phone numbers exchanged — private, fast, and secure communication."],
];
